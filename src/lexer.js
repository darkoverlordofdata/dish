...
function Tokenizer(source) {
    ...
    function isKeyword(wd)      {
        return /break|case|continue|const|delete|do|double|else|export|float|for|if|import|int|module|new|print|return|switch|to!int|to!double|to!float|uint|while/.test(wd);
    }
